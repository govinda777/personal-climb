      ...
      <section className="pt-40 pb-20 px-6">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <h1 className="text-6xl md:text-8xl font-black italic tracking-tighter uppercase leading-none">
            Escale seu <br />
            <span className="text-zinc-700">Negócio.</span>
          </h1>
          <p className="text-xl text-zinc-400 font-bold italic uppercase">
            A primeira plataforma white-label pensada exclusivamente para
            treinadores de escalada de alta performance.
          </p>
          <div className="pt-10">
            <Button
              onClick={login}
        ...
        {[
          {
            ...
            desc: "Tenha seu próprio hotsite profissional com seu domínio e cores.",
          },
          {
            title: "Prescrição com IA",
            desc: "Gere treinos baseados no seu protocolo e na evolução do aluno.",
          },
          {
            title: "Gestão Financeira",
            desc: "Pagamentos recorrentes e cobrança por aluno ativo via Stripe.",
          },
        ].map((item, i) => (
          <div
            key={i}
            className="p-8 border border-white/5 bg-zinc-900/30 space-y-4"
          >
