...
export default function ProfessorDashboard() {
  ...
  useEffect(() => {
    async function loadDashboard() {
      ...
      try {
        ...
        setError(
          "Falha ao carregar dashboard. Verifique sua conexão ou status de personal.",
        );
      } finally {
        setLoading(false);
      }
    ...
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-zinc-50">
        <p className="mb-4 text-zinc-600 font-medium">
          Faça login para acessar o painel do treinador.
        </p>
  ...
  if (loading) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen bg-zinc-50">
        <span className="animate-pulse font-bold text-zinc-500 uppercase tracking-widest">
          ...
          {statCards.map((stat, i) => (
            ...
            >
              <div className="flex justify-between items-start">
                ...
                <stat.icon
                  className={`w-5 h-5 ${stat.color || "text-zinc-400"}`}
                />
              </div>
              ...
              <tbody className="divide-y divide-zinc-100">
                {students.length === 0 ? (
                  <tr>
                    ...
                    >
                      Nenhum aluno cadastrado ainda. Compartilhe seu link de
                      hotsite!
                    </td>
                  </tr>
                ) : (
