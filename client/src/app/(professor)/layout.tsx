      ...
      <aside className="w-64 border-r border-zinc-200 bg-white hidden lg:flex flex-col">
        <div className="p-6 border-b border-zinc-100">
          <div className="text-xl font-bold tracking-tighter">
            ...
            <span className="ml-2 text-[10px] bg-zinc-900 text-white px-2 py-0.5 rounded">
              PRO
            </span>
          </div>
        </div>
        <nav className="flex-1 p-4 space-y-1">
          <a
            ...
            className="flex items-center gap-3 px-4 py-2 text-sm font-medium bg-zinc-100 rounded-lg text-zinc-900"
          >
            Dashboard
          </a>
          <a
            href="/professor/students"
            className="flex items-center gap-3 px-4 py-2 text-sm font-medium text-zinc-500 hover:bg-zinc-50 rounded-lg transition-colors"
          >
            Students
          </a>
          <a
            href="/professor/programs"
            className="flex items-center gap-3 px-4 py-2 text-sm font-medium text-zinc-500 hover:bg-zinc-50 rounded-lg transition-colors"
          >
            Training Programs
          </a>
